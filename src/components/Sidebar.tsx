...
interface SidebarContentProps {
  ...
  getBadgeCount: (badge?: 'cart' | 'wishlist') => number;
    ...
    <>
      <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
        ...
        <button
          ...
          className="p-2 -mr-2 rounded-full hover:bg-gray-100 transition-colors md:hidden"
        >
...
export default function Sidebar() {
  ...
  return (
    <>
        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 z-50 w-4/5 max-w-xs bg-white shadow-2xl flex flex-col md:hidden"
            >
              <SidebarContent
                initials={initials}
      ...
      <div className="hidden md:flex md:sticky md:top-0 md:h-screen md:w-64 md:flex-col md:bg-white md:border-r md:border-gray-100">
        <SidebarContent
          initials={initials}
          displayName={displayName}
          memberLabel={memberLabel}
